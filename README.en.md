...
- **119 cmdlets** — 119 built-in cmdlets plus 77 of their aliases, covering files, paths, processes, services, system information, JSON/CSV conversion, formatting, and more.
...
119 cmdlets are built in, plus 77 aliases. For each command's usage, version and distro requirements, and its bash equivalent, see [docs/CommandReference.en.md](docs/CommandReference.en.md).  
