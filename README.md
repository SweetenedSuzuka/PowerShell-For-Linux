...
- **支持 128 个 cmdlet 命令** —— 支持 128 个内置 cmdlet 以及它们的 77 个别名，覆盖文件、路径、进程、服务、系统信息、JSON/CSV 转换、格式化等。  
...
内置 128 个 cmdlet 命令，外加 77 个别名。每条命令的用法、版本和发行版要求，以及它对应 bash 的什么写法，见 [docs/指令参考.md](docs/指令参考.md)。  
