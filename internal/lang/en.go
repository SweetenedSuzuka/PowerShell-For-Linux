...
`,
	...
	MsgParseRedirDupOut:         "The output stream for this command is already redirected",
	MsgParseRedirDupErr:         "The error stream for this command is already redirected",
	...
	MsgCountRange:                   "The '-Count' parameter cannot be less than 1.",
	MsgNewestRange:                  "The '-Newest' parameter cannot be less than 1.",
	...
	MsgObjectPropNotFound:           "Object does not have property '%s'.",
	MsgPropNotCollection:            "Property '%s' is not a collection.",
	...
	MsgCredentialHeader:             "PowerShell credential request",
	MsgCredentialPrompt:             "Enter your credentials.",
	MsgCredentialPassword:           "Password for user %s: ",
