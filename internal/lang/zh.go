...
`,
	...
	MsgParseRedirDupOut:         "该命令的输出流已重定向",
	MsgParseRedirDupErr:         "该命令的错误流已重定向",
	...
	MsgIncrTargetInvalid:   "增量/减量运算符不支持该目标。",
	MsgArithmeticInvalid:   "算术运算需要数字操作数。",
	MsgSubstringOutOfRange: "子字符串起始下标或长度超出范围。",
	...
	MsgCountRange:                   "参数 \"-Count\" 不能小于 1。",
	MsgNewestRange:                  "参数 \"-Newest\" 不能小于 1。",
	...
	MsgObjectPropNotFound:           "对象不存在属性 %s。",
	MsgPropNotCollection:            "属性 %s 不是集合。",
	...
	MsgCredentialHeader:             "PowerShell 凭据请求",
	MsgCredentialPrompt:             "输入凭据。",
	MsgCredentialPassword:           "%s 的密码: ",
